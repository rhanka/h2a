...
> Last update: 2026-05-23 (Release v0.1.19 published ; DEC-057 — skill h2a unique avec sous-commandes graphify-style + receive/negotiate ; legacy pruning auto)
...
- Published packages:
  - `@sentropic/h2a@0.1.19`
  - `@sentropic/h2a-cli@0.1.19`
- Current repo state:
  ...
  - `v0.1.19` is tagged on GitHub and published to npm through Trusted Publishing
...
- [x] Publish `@sentropic/h2a@0.1.19`
- [x] Publish `@sentropic/h2a-cli@0.1.19`
...
- [x] Add npm install smoke test for published packages (`.github/workflows/smoke.yml`, installs `@sentropic/h2a-cli@0.1.19` globally and exercises help/hosts/MCP tools/init/register/discover/host setup)
