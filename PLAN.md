...
- Published packages:
  - `@sentropic/h2a@0.1.21`
  - `@sentropic/h2a-cli@0.1.21`
- Current repo state:
  ...
  - `v0.1.21` is tagged on GitHub and published to npm through Trusted Publishing
...
- [x] Publish `@sentropic/h2a@0.1.21`
- [x] Publish `@sentropic/h2a-cli@0.1.21`
...
- [x] Add npm install smoke test for published packages (`.github/workflows/smoke.yml`, installs `@sentropic/h2a-cli@0.1.21` globally and exercises help/hosts/MCP tools/init/register/discover/host setup)
