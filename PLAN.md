...
- Published packages:
  - `@sentropic/h2a@0.1.11`
  - `@sentropic/h2a-cli@0.1.11`
- Current repo state:
...
- [x] Publish `@sentropic/h2a@0.1.11`
- [x] Publish `@sentropic/h2a-cli@0.1.11`
...
- [x] Add npm install smoke test for published packages (`.github/workflows/smoke.yml`, installs `@sentropic/h2a-cli@0.1.11` globally and exercises help/hosts/MCP tools/init/register/discover/host setup)
