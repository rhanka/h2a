...
- Published packages:
  - `@sentropic/h2a@0.1.24`
  - `@sentropic/h2a-cli@0.1.24`
- Current repo state:
  ...
  - `v0.1.24` is tagged on GitHub and published to npm through Trusted Publishing ; OCI image `ghcr.io/rhanka/h2a-cli:0.1.24` + `:latest` published to GHCR ; repo is now public (DEC-062 + safePathSegment runtime fix for Windows)
...
- [x] Publish `@sentropic/h2a@0.1.24`
- [x] Publish `@sentropic/h2a-cli@0.1.24`
...
- [x] Add npm install smoke test for published packages (`.github/workflows/smoke.yml`, installs `@sentropic/h2a-cli@0.1.24` globally and exercises help/hosts/MCP tools/init/register/discover/host setup)
