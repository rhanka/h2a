...
- Published packages:
  - `@sentropic/h2a@0.1.23`
  - `@sentropic/h2a-cli@0.1.23`
- Current repo state:
  ...
  - `v0.1.23` is tagged on GitHub and published to npm through Trusted Publishing ; OCI image `ghcr.io/rhanka/h2a-cli:0.1.23` + `:latest` published to GHCR (DEC-060, first multi-arch image)
...
- [x] Publish `@sentropic/h2a@0.1.23`
- [x] Publish `@sentropic/h2a-cli@0.1.23`
...
- [x] Add npm install smoke test for published packages (`.github/workflows/smoke.yml`, installs `@sentropic/h2a-cli@0.1.23` globally and exercises help/hosts/MCP tools/init/register/discover/host setup)
