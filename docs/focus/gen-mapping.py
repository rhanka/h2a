...
coordinate = [
    ...
    R("h2a drive", False, DASH, "h2a wake", "hcli","rt", desc="réveille un agent idle"),
    ...
    R("remote h2a ping <instance>", True, DASH, "h2a relay ping", "rcli","rt", desc="ping un agent distant"),
