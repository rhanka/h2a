...
| **S4** | ✅ **done (DEC-100, unreleased)** — `sysmlQueryScope(mode)` maps every DEC-045 disclosure mode → `{fetch, detail, view?}` (abstract; per-API param translation out of V1 scope) | `@sentropic/h2a-cli` | S2, DEC-045 |
