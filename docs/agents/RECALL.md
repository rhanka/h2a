...
Applying reading rule 8 to this very table: what refuses here is `--check`, which refuses a
projection that has drifted from the journal. Nothing refuses a decision that no code obeys.
