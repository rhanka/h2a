...
> A *certification* evaluation: model an organization that **achieves ISO 9001:2015** while **optimizing its use of h2a** — h2a's process engagements, append-only journal, controls and controlled disclosure become the **audit trail** a QMS auditor wants. [← library](./README.md) · **Status: reviewed (2/3)** — agy + codex both `revise`; changes applied 2026-05-28; R3 (claude) deferred (timeout).
