...
{"name":"h2a_drive_consent_revoke","description":"Drive consent revoke. Pair/time scope; explicit dates required. Signing uses the bound MCP identity. Signatures prove key possession, not human intent.","inputSchema":{"type":"object","properties":{"from":{"type":"string"},"to":{"type":"string"},"requestId":{"type":"string"},"reason":{"type":"string"}},"required":["from","to"],"additionalProperties":false}},
