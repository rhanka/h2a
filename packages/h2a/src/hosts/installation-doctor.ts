...
import { CLAUDE_NATIVE_REPAIRABLE_ROOT_KEYS } from "./installation-doctor-contract.js";
...
function removeOwnedJsonMcpEntries(raw: string): string | undefined {
  ...
  const mcpServers = root?.find((property) => property.key === CLAUDE_NATIVE_REPAIRABLE_ROOT_KEYS[0]);
